...
void main() {
  test('defaults: music and haptics on, system theme, grid off, onboarding pending', () {
  ...
  test('copyWith and equality', () {
    ...
    final grid = dark.copyWith(hapticsOn: false, gridLinesOn: true, musicOn: false, musicVolume: 0.2, onboardingDone: true);
